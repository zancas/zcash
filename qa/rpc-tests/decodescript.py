...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decoderawtransaction_asm_sighashtype(self):
        ...
        txsave_serialized = txSave.serialize()
        rpc_result = self.nodes[0].decoderawtransaction(hexlify(txsave_serialized))
        assert_equal(str(signature_sighash_decoded)[2:].strip("'"), rpc_result['vin'][0]['scriptSig']['asm'])
